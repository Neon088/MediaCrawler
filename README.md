...
- **安装地址**：[uv 官方安装指南]()
- **验证安装**：终端输入命令 ``，如果正常显示版本号，证明已经安装成功
...
>
> 目前开放了 `` 和 `` 这两个使用 CDP 的方式连接本地浏览器，如有需要，查看 `` 中的配置项。
...
> 如果是爬取抖音和知乎，需要提前安装 nodejs 环境，版本大于等于：`` 即可
